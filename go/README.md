...
Go implementation of the dflockd distributed lock server. Wire-compatible with the Python server — existing Python/TypeScript clients work without changes.
...
# Use existing Python clients as normal
python -c "
